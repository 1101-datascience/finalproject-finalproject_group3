...
traindata <- fread("input/train.csv",stringsAsFactors=TRUE)
testdata <- fread("input/test.csv",stringsAsFactors=TRUE)
...
write.csv(predictions.xgbm,"prop_price_xgb.csv",row.names = FALSE)
